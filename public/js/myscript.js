...
var aspectRatio = 0.9;  // standard definition video aspect ratio
var maxCALLERS = 3;
...
function loginSuccess() {
    ...
    easyrtc.showMessage("loginSuccessfull","Welcome to room " + roomName);

    easyrtc.joinRoom(roomName, null,
      function(roomName) {
                console.log('Room joined');
               // easyrtc.showMessage("joinSuccessfull", "Someone have joined your room");
...
function appInit() {
    ...
    easyrtc.setOnCall( function(easyrtcid, slot) {
        ...
        if (easyrtc.getConnectionCount() >= 1) {   
           easyrtc.showMessage("joinSuccessfull", easyrtcid + " have joined room " + roomName);     
        }
        boxUsed[slot+1] = true;
    ...
    easyrtc.setOnHangup(function(easyrtcid, slot) {
        ...
        easyrtc.showMessage("leaveSuccessfully", easyrtcid + " have left room");
